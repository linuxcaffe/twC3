const {TaskProvider} = require("./provider.js");;
const {formatters, parseDate, sortTasks, calcColorStyles, isoDate} = require("./format.js");;
const {EventEmitter} = require("../tool/events.js");;
const {init as styleInit} = require("../styles/style.js");;
const {init as stylesInit} = require("../styles/main.js");;
class StreamEater {
    eat(line) {
        // Implement me
    }
...
module.exports = {StreamEater, ToArrayEater, ToStringEater, TaskController};