...
import {formatters, parseDate, sortTasks, calcColorStyles, isoDate} from './format.js';
import {EventEmitter} from '../tool/events.js';
import {init as styleInit} from '../styles/style.js';
import {init as stylesInit} from '../styles/main.js';
class StreamEater {
    eat(line) {
        // Implement me
    }
